...
public class Task_2_Person {
	private String firstName;
	private String lastName;
	private int age;
	private LocalDate dateOfBirth;

	public Task_2_Person() {
		super();
	}

	public Task_2_Person(String firstName, String lastName, int day, int month, int year) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Task_2_Person other = (Task_2_Person) obj;
